...
ah fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.99,36.596,44,31.023,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
  );
}
...
const createDefaultSettings = async (firestore: any, userId: string) => {
    ...
    if (!docSnap.exists()) {
      // Get member count to set totalMembers correctly
